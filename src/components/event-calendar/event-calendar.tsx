...
export interface EventCalendarProps {
    ...
    /** Map of ISO date strings (YYYY-MM-DD) to OAC reception dates for month-view stamping */
                ...
                <div className={cn('flex items-center justify-between p-2 sm:p-4', className)}>
                    ...
                    <div className="flex items-center gap-2">
                            ...
                            <DropdownMenuTrigger asChild>
                                <Button
                                    ...
                                    <span className="pt-0.5">
                                        <span
                                            aria-hidden="true"
                                            className="pt-0.5 min-[480px]:hidden">
                        ...
                        <Button
                            ...
                            <span className="pt-0.5 max-sm:sr-only">Nuevo evento</span>
                        </Button>
                    </div>
                </div>
