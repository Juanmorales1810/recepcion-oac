...
interface MonthViewProps {
    ...
    /** Map of ISO date strings (YYYY-MM-DD) to reception dates for OAC stamping */
    oacReceptionMap?: OacReceptionMap;
}
                ...
                {weeks.map((week, weekIndex) => (
                    <div
                        ...
                        {week.map((day, dayIndex) => {
                            ...
                            const oacReceived = oacReceptionMap[dayKey];
                            const oacStamp = getOacStamp(day, oacReceived);
                            const oacStampClasses = getOacStampClasses(oacStamp);
                                    ...
                                    <DroppableCell
                                        ...
                                        <div
                                            className={cn(
                                                ...
                                                // OAC stamp overrides today's style only if no stamp
                                                oacStamp
                                                    ? oacStampClasses
                                            ...
                                            title={
                                                oacStamp === 'green'
                                                    ? 'OAC recepcionada a tiempo'
                                                    : oacStamp === 'red'
                                                      ? 'OAC recepcionada fuera de plazo'
                                                      : oacStamp === 'black'
                                                        ? 'OAC del mes anterior sin recepción en los primeros 5 días hábiles'
                                                        : undefined
                                            }>
                                            {format(day, 'd')}
                                        </div>
                                        <div
                                            className="min-h-[calc((var(--event-height)+var(--event-gap))*1)] sm:min-h-[calc((var(--event-height)+var(--event-gap))*1.5)] lg:min-h-[calc((var(--event-height)+var(--event-gap))*2)] 2xl:min-h-[calc((var(--event-height)+var(--event-gap))*4)]"
